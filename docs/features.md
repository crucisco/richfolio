...
**STRONG BUY** tickers also get a **"More Details"** link in the email and Telegram message. Clicking it opens a dedicated analysis page on GitHub Pages with an interactive TradingView chart, detailed buy thesis, risk analysis, key metrics, fundamentals, and action summary — all generated by Gemini 2.5 Pro.
